        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                ...
                <?php
                        ...
                        // dd(substr($camelName, 0, 4));
                        if (substr($camelName, 0, 4) == "Api/") {
                            $arrNameApi = explode('/',$menu->controller);
                            $cNameApi = end($arrNameApi);
                            unset($arrNameApi[count($arrNameApi) - 1]);
                            $prefix = implode("\\",$arrNameApi);

                            $camelName =  Inflector::id2camel($cNameApi);
                            $fullControllerName = "app\\controllers\\$prefix\\" . $camelName . "Controller";
                        }
