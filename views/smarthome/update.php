...
$this->title = 'Smarthome ' . $model->nama . ', ' . 'Edit';
$this->params['breadcrumbs'][] = ['label' => 'Smarthome', 'url' => ['index']];
...
<?php echo $this->render('_form-detail', compact("model", "modelKontrol", 'modelSirkuit', 'dropdownPin')); ?>