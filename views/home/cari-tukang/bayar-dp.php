        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-contact-wrap m-t-20">
                    <h4 class="mb-0">Form Pembayaran DP</h4>
                    <p class="mb-3"><strong>Biaya yang harus ditransfer</strong> : <?= \Yii::$app->formatter->asRp($model->nominal_dp) ?></p>
                    ...
                    <div class="row">
                        <?= $form->field($model, 'bukti_dp', \app\components\Constant::COLUMN(1))->widget(FileInput::class, [
                            'options' => [
                                'accept' => 'image/*'
                            ]
                        ]) ?>
                        <?= $form->field($model, 'keterangan_pembayaran_dp', \app\components\Constant::COLUMN(1))->textarea(['rows' => 6]) ?>
                    </div>
