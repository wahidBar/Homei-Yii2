...
<section class="slide2">
    ...
    <div class="rev_slider_wrapper">
        <div id="revolution-slider1" class="rev_slider" data-version="5.4.4" style="display: none;">
            <ul>
                <li data-transition="crossfade" data-slotamount="7" data-masterspeed="2000" data-delay="100000000000">
                    <!--  BACKGROUND IMAGE -->
                    <div id="image-map">
                        ...
                        <?php foreach ($dproduks as $produk) { ?>
                            <div class="<?= (($produk->y_pos <= 50) ? "pin" : (($produk->y_pos > 50) ? "pin pin-down" : "pin")) ?>" data-xpos="<?= $produk->x_pos ?>" data-ypos="<?= $produk->y_pos ?>">
                                ...
                                <div class="text-center">
                                    <h2><?= implode(' ', array_slice(explode(' ', $produk->supplierBarang->nama_barang), 0, 2)) ?></h2>
    ...
    <div class="parallax">
        <div class="container">
            <div class="">
                ...
                <div class="col-lg-12 map-height">
                    <div id="image-map">
                        <img style="width: 100%;height: auto;" src="<?= \Yii::$app->request->baseUrl . "/uploads/" . $cproduk->gambar ?>">
                        <?php foreach ($dproduks as $produk) { ?>
                            <div class="<?= (($produk->y_pos <= 50) ? "pin" : (($produk->y_pos > 50) ? "pin pin-down" : "pin")) ?>" data-xpos="<?= $produk->x_pos ?>" data-ypos="<?= $produk->y_pos ?>">
