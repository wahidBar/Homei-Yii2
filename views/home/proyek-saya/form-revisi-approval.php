...
$this->registerJs("
      tinymce.init({
        selector: '#approvalsebelumpekerjaan-revisi'
      });
");
?>
<!-- Navigation -->
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 pb-3">
                <div class="list-group" style="border-style: solid;border-color: #ebcd1e;border-radius: 5px;">
                    ...
                    <?= Html::a('Dashboard', ['detail-proyek', 'id' => $model->proyek->kode_unik], ['class' => 'list-group-item list-group-item-action' . $link_dashboard]) ?>
                    <?= Html::a('Keuangan', ['keuangan', 'id' => $model->proyek->kode_unik], ['class' => 'list-group-item list-group-item-action' . $link_uang]) ?>
                    <?= Html::a('Pantau Proyek', ['pantau-proyek', 'id' => $model->proyek->kode_unik], ['class' => 'list-group-item list-group-item-action' . $link_cctv]) ?>
                    <?= Html::a('Pembayaran', ['pembayaran', 'id' => $model->proyek->kode_unik], ['class' => 'list-group-item list-group-item-action' . $link_bayar]) ?>
                </div>
            </div>
                ...
                <div class="col-lg-12 col-12 layout-spacing">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <?= $form->field($model, 'revisi', \app\components\Constant::COLUMN(1))->textarea(['rows' => 6, 'class' => 'form-control mt-3 mb-3']) ?>
                            <hr />
