            ...
            <div class="">
                ...
                <div class="d-flex flex-wrap pt-3">
                    ...
                    <?= $form->field($model, 'name', Constant::COLUMN(2, false))
                        ->textInput(['maxlength' => true]) ?>
                        <?= $form->field($model, 'email', Constant::COLUMN(2, false))
                        ->textInput(['type' => 'email']) ?>
                        <?= $form->field($model, 'no_hp', Constant::COLUMN(2, false))
                        ->textInput(['type' => 'number']) ?>
                    <?= $form->field($model, 'role_id', Constant::COLUMN(2, false))
                        ->widget(\kartik\select2\Select2::classname(), [
                            'data' => \yii\helpers\ArrayHelper::map(app\models\Role::find()->all(), 'id', 'name'),
