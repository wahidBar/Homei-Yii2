            ...
            <div class="card-body">
                ...
                <div class="d-flex  flex-wrap">
                    <div class="col-md-12 text-center">
                        <?= Yii::$app->formatter->asDownload($model->dokumen_tor) ?>
                    </div>
                    <div class="clearfix"></div>

                    <?= $form->field($model, 'dokumen_tor', \app\components\Constant::COLUMN(1))->widget(FileInput::class, [
                        'options' => [
                            // 'accept' => 'image/*'
                        ]
                    ]) ?>
