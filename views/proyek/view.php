...
<div class="giiant-crud proyek-view">
    ...
    <?php if (Yii::$app->user->identity->role_id == 1) : ?>
        ...
        <p class="pull-right">
            ...
            <?php if ($model->status != 3 && $model->status != 1) : ?>
                <button type="button" class="btn btn-primary mr-1 mt-1" data-toggle="modal" data-target="#confirm" id="btn-end">
                    Pengajuan Selesai
                </button>
            <?php endif ?>
        </p>
    ...
    <?php $this->beginBlock('ApprovalSebelumPekerjaan') ?>
    <div class="row">
        <div class="col-12 col-sm-12 mb-3">
            <h4>Approval Sebelum Pekerjaan</h4>
            <div class="card m-b-30">
                <div class="card-body">
                    <?= $this->render('_view/_approval_sebelum_pekerjaan', compact('model')) ?>
                </div>
            </div>
        </div>
    </div>
    ...
    <?= Tabs::widget(
        [
            ...
            'items' => [
                ...
                [
                    'label'   => '<b class="">Approval</b>',
                    'content' => $this->blocks['ApprovalSebelumPekerjaan'],
                    'active'  => false,
                ],
                [
