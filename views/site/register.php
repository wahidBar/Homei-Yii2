        ...
        <div class="left-container">
            ...
            <div class="main">
                ...
                <?= $form
                    ...
                    ->label(false)
                    ->textInput(['placeholder' => $model->getAttributeLabel('No HP (Whatsapp)')]) ?>
                <?= $form
                ...
                <?= $form
                    ...
                    ->checkbox([
                        'checked' => false,
                        'uncheck' => null,
                        'label' => 'Saya setuju dengan <a href="' . \Yii::$app->request->BaseUrl . '/home/syarat-ketentuan" target="_blank">Syarat dan Ketentuan</a>',
                        'style' => 'width:auto',
                        'required' => true
                    ]) ?>
                ...
                <div style="display: -ms-flexbox;display: flex;-ms-flex-wrap: wrap;flex-wrap: wrap;">
                    <div style="-ms-flex: 0 0 50%;flex: 0 0 50%;max-width: 50%;padding-right: 10px;">
                        <div class="login-now">
                            <?= Html::submitButton('Daftar', ['name' => 'login-button', 'id' => 'logIn']) ?>
                        </div>
                    </div>
                    <div style="-ms-flex: 0 0 50%;flex: 0 0 50%;max-width: 50%;padding-right: 10px;">
                        <div class="login-now">
