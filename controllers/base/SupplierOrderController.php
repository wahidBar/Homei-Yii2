...
/**
 * SupplierOrderController implements the CRUD actions for SupplierOrder model.
 **/
class SupplierOrderController extends \app\components\productive\DefaultActiveController
{
    ...
    /**
     * Lists all SupplierOrder models.
     * @return mixed
     */
    ...
    /**
     * Creates a new SupplierOrder model.
    ...
    /**
     * Finds the SupplierOrder model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SupplierOrder the loaded model
     * @throws HttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SupplierOrder::findOne($id)) !== null) {
            return $model;
        } else {
