 ...
 **/
class SlidesController extends \app\components\productive\DefaultActiveController
{
    ...
    public function actionCreate()
    {
        ...
        try {
            if ($model->load($_POST)) :
                $params = [];
                if (Yii::$app->request->post("Slides")['params']) {
                    foreach (Yii::$app->request->post("Slides")['params'] as $param) {
