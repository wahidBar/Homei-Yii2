 ...
 **/
class TestimonialsController extends \app\components\productive\DefaultActiveController
{
    use UploadFile;
    /**
    ...
    public function actionCreate()
    {
        ...
        try {
            if ($model->load($_POST)) :
                ...
                if ($file) {
                    $response = $this->uploadImage($file, "testmonials", $model::DEFAULT_FILE_VALIDATION);
    ...
    public function actionUpdate($id)
    {
        ...
        try {
            if ($model->load($_POST)) :
                $file = UploadedFile::getInstance($model, "gambar");
                if ($file) {
                    $response = $this->uploadImage($file, "testimonials", $model::DEFAULT_FILE_VALIDATION);
                    if ($response->success == false) {
