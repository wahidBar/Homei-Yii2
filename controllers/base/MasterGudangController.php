...
use app\models\search\MasterGudangSearch;
...
/**
 * MasterGudangController implements the CRUD actions for MasterGudang model.
 **/
class MasterGudangController extends \app\components\productive\DefaultActiveController
{
    ...
    */
    ...
    {
        $searchModel  = new MasterGudangSearch;
