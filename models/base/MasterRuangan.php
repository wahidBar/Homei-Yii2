...
/**
 * This is the base-model class for table "t_master_ruangan".
 *
 * @property integer $id
 ...
 */
abstract class MasterRuangan extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\IsianLanjutanRuangan::className(), ['id_ruangan' => 'id']);
    }
    ...
    /**
     * @inheritdoc
     * @return \app\models\query\MasterRuanganQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new \app\models\query\MasterRuanganQuery(get_called_class());
    }
