...
class Generator extends BaseGenerator
{
    ...
    public function generate()
    {
        ...
        $restControllerFileV1 = StringHelper::dirname($controllerFile).'/api/v1/'.StringHelper::basename($controllerFile);
        // $restControllerFileDev = StringHelper::dirname($controllerFile).'/api/dev/'.StringHelper::basename($controllerFile);
        ...
        //     $files[] = new CodeFile($restControllerFileDev, $this->render('controller-rest-dummy.php', $params));
        // }

        if ($this->overwriteRestControllerClass || !is_file($restControllerFile)) {
            $files[] = new CodeFile($restControllerFileV1, $this->render('controller-rest.php', $params));
        }
